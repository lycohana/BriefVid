    ...
    intake: `
      <article class="grid-card library-intake-card">
        <div class="panel-header">
          ...
          <p>输入 Bilibili / YouTube 视频链接，或直接填写 BV 号后，系统会抓取封面和标题，并立即开始本地总结。</p>
        </div>
        <form id="probe-form" class="task-form">
          <label class="input-row">
            <span class="input-label">视频链接</span>
            <input id="probe-url-input" type="text" class="input-field" placeholder="https://www.bilibili.com/video/...、https://www.youtube.com/watch?v=... 或 BV1xx411c7mD" required autocomplete="off" />
          </label>
