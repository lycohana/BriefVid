...
function getBilibiliCookieExportPath() {
  return path.join(getLocalAppDataDir(), "briefvid", "data", "cookies", "bilibili.txt");
}
...
async function exportBilibiliCookies(cookies: Electron.Cookie[]): Promise<BilibiliCookieExportResult> {
  ...
  const lines = [
    ...
    "# Generated by BriefVid from the in-app Bilibili login window.",
    ...exportableCookies
